...
# Create 2 instance for this ALB fetching instance name from ec2 output
...
resource "aws_lb" "my-aws-alb" {
  ...
  #To deploy instenace in 2 availability zone fetching public subnets from vpc
  subnets = [
    "${var.subnet1}",
    "${var.subnet2}",
  ]
